...
- AROMAMATRIX project positioning: `brand.positioning`
- Transaction entity notice: `transaction.entityNotice`
...
- Present AROMAMATRIX as an international B2B perfume manufacturing program. Do not frame the public website around separate brand and sales companies. Keep the manufacturing certificate holder accurate, and state that the transaction entity is identified in the applicable quotation, contract, proforma invoice and payment documents.
